  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['123 Food Street', 'Gourmet District', 'Mumbai, Maharashtra 400001']
    },
    {
      icon: Phone,
      title: 'Call Us',
    ...
    },
    {
      icon: Clock,
      title: 'Working Hours',
      details: ['Mon - Sun: 8:00 AM - 11:00 PM', 'Customer Support 24/7']
    }
  ];
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
                  >
            ...
            {[
              {
                ...
                answer: 'We deliver from 8:00 AM to 11:00 PM, seven days a week. Our customer support is available 24/7 to assist you.'
              },
              {
                question: 'What is the minimum order amount?',
                answer: 'There is no minimum order amount. However, orders above ₹500 qualify for free delivery.'
              },
              {
                question: 'How can I track my order?',
                answer: 'Once your order is confirmed, you will receive real-time updates via SMS and email. You can also track your order through our app.'
              },
              {
